...
public class TRABAJARCONOBLIGATORIO {
    ...
    public static void main(String[] args) {
        ...
        juegodepruebaSistema(obl, p); // juego de prueba ejemplo
    ...
    public static void juegodepruebaSistema(Obligatorio obl, Prueba p) {
        ...
        p.ver(obl.crearSistemaMensajes(10).resultado, Retorno.Resultado.OK, "Se creara un sistema para 10 palabras por línea");
    ...
    public static void juegodepruebaContactos(Obligatorio obl, Prueba p) {
        ...
        p.ver(obl.agregarContacto(2, "Jorge").resultado, Retorno.Resultado.OK, "Se agrega un contacto con el número 2 y el nombre Jorge, Esperado: OK");
        p.ver(obl.agregarContacto(3, "Victoria").resultado, Retorno.Resultado.OK, "Se agrega un contacto con el número 3 y el nombre Victoria, Esperado: OK");
        p.ver(obl.agregarContacto(4, "Andres").resultado, Retorno.Resultado.OK, "Se agrega un contacto con el número 4 y el nombre Andres, Esperado: OK");
        p.ver(obl.agregarContacto(5, "Mauro").resultado, Retorno.Resultado.OK, "Se agrega un contacto con el número 5 y el nombre Mauro, Esperado: OK");
        p.ver(obl.agregarContacto(6, "Juan").resultado, Retorno.Resultado.OK, "Se agrega un contacto con el número 6 y el nombre Juan, Esperado: OK");
        p.ver(obl.agregarContacto(7, "Francisco").resultado, Retorno.Resultado.OK, "Se agrega un contacto con el número 7 y el nombre Francisco, Esperado: OK");
        p.ver(obl.agregarContacto(8, "Felipe").resultado, Retorno.Resultado.OK, "Se agrega un contacto con el número 8 y el nombre Felipe, Esperado: OK");
        p.ver(obl.agregarContacto(9, "Sebastian").resultado, Retorno.Resultado.OK, "Se agrega un contacto con el número 9 y el nombre Sebastian, Esperado: OK");
        p.ver(obl.agregarContacto(10, "Ana").resultado, Retorno.Resultado.OK, "Se agrega un contacto con el número 10 y el nombre Ana, Esperado: OK");
